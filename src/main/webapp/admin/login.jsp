...
<head>
    ...
    <link rel="stylesheet" type="text/css"
            href="${pageContext.request.contextPath}/css/webbase.css"/>
...
<%--                        <div class="logined">--%>
<%--                            <a class="sui-btn btn-block btn-xlarge btn-danger" href="javascript:document:loginform.submit();"--%>
<%--                               target="_self">登&nbsp;&nbsp;录</a>--%>
<%--                        </div>--%>
                        <div class="logined">
                            <button type="submit" class="sui-btn btn-block btn-xlarge btn-danger" style="border:none;">
                                登&nbsp;&nbsp;录
                            </button>
                        </div>
                    </form>
