...
public class MyBatisConfig {
    ...
    为set注入提供数据源，dataSource 来源于JdbcConfig 中的配置
     */
    @Bean
    public SqlSessionFactoryBean getSqlSessionFactoryBean(
        ...
        // 等同于<properties name = "dataSource" ref = "dataSource"/>
    ...
    public MapperScannerConfigurer getMapperScannerConfigurer(){
        ...
        // 等同于<property name = "basePackage" value = "com.sea.dao"/>
        msc.setBasePackage("com.sea.mapper");
        return msc;
    }
}
